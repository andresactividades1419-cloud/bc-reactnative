  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Ingresa tus credenciales para gestionar tus producciones</Text>
      </View>
      ...
      >
        <Text style={styles.linkText}>
          ¿No tienes cuenta?{' '}
          <Text style={styles.linkHighlight}>Únete al equipo de producción</Text>
        </Text>
      </Pressable>
    </ScrollView>
  );
